...
function VotarConcert() {
    ...
    $con = conectar("webmusica");
    //Definimos la consulta
    $query ="select id_concert,nom, data_concert from concerts ;";
...
function insertarVotacioConcert($votaciomusic) {


    $con = conectar("webmusica");
    $insert = "insert into votarconcert values ('fan1', 'music1', '$votaciomusic')";
    if (mysqli_query($con, $insert)) {
        echo "<p>Votació correcte</p>";
    } else {
        echo mysqli_error($con);
